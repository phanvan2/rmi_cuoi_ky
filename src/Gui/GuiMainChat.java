...
//	public PacketUser packet; // label user  list user in guiclient
	public boolean group = false ; // if true => group , if false => people
...
//	
	...
	public void initData() {
		...
		try {
			...
			String sql_user = "SELECT * FROM `public_chat`" ; 
			Vector<Mess> vtdata=obj.getDataMess(sql_user);
			for (Mess mess : vtdata) {
			//	System.out.println(mess.getContent());
				vtMess.add(mess.getContent()); 
			}
